...
#pragma warning(disable: 4127)
    ...
    else if (false)
    {
        ...
        wor.ValueGenerator = [](Worley3D::DistanceValues vals)
                             {
...
void VoxelWorld::InitializeWorld(void)
{
    ...
    finalWorldRenderParams.Texture2Ds["u_finalWorldRender"].Texture =
    ...
    * 1: UV
    */
    voxelParams.Floats["u_corner1"] = UniformValueF(Vector3f(-1.0f, -1.0f, -1.0f), "u_corner1");
    voxelParams.Floats["u_corner2"] = UniformValueF(Vector3f(1.0f, -1.0f, -1.0f), "u_corner2");
    voxelParams.Floats["u_corner3"] = UniformValueF(Vector3f(-1.0f, 1.0f, 1.0f), "u_corner3");
    voxelParams.Floats["u_corner4"] = UniformValueF(Vector3f(1.0f, 1.0f, 1.0f), "u_corner4");
...
{                                                                                              \n\
    ...
    //Parameters.
    UniformLocation voxelTexLoc = voxelMat->GetUniforms().FindUniform("u_voxelTex").Loc;
    voxelParams.Texture2Ds["u_voxelTex"] = UniformValueSampler2D(voxelTex.GetTextureHandle(),
                                                                 "u_voxelTex", voxelTexLoc);
...
void VoxelWorld::RenderOpenGL(float elapsed)
{
    ...
    voxelParams.Floats["u_surfaceNormal"].SetValue(Vector3f(-1.0f, 0.0f, 0.0f));
    voxelParams.Floats["u_corner1"].SetValue(Vector3f(-halfVox, -halfVox, -halfVox));
    voxelParams.Floats["u_corner2"].SetValue(Vector3f(-halfVox, halfVox, -halfVox));
    voxelParams.Floats["u_corner3"].SetValue(Vector3f(-halfVox, -halfVox, halfVox));
    voxelParams.Floats["u_corner4"].SetValue(Vector3f(-halfVox, halfVox, halfVox));
    voxelParams.Subroutines["u_getQuadDecider"].ValueIndex = 0;
    voxelMat->Render(info, lessX, voxelParams);

    voxelParams.Floats["u_surfaceNormal"].SetValue(Vector3f(0.0f, -1.0f, 0.0f));
    voxelParams.Floats["u_corner1"].SetValue(Vector3f(-halfVox, -halfVox, -halfVox));
    voxelParams.Floats["u_corner2"].SetValue(Vector3f(-halfVox, -halfVox, halfVox));
    voxelParams.Floats["u_corner3"].SetValue(Vector3f(halfVox, -halfVox, -halfVox));
    voxelParams.Floats["u_corner4"].SetValue(Vector3f(halfVox, -halfVox, halfVox));
    voxelParams.Subroutines["u_getQuadDecider"].ValueIndex = 1;
    voxelMat->Render(info, lessY, voxelParams);

    voxelParams.Floats["u_surfaceNormal"].SetValue(Vector3f(0.0f, 0.0f, -1.0f));
    voxelParams.Floats["u_corner1"].SetValue(Vector3f(-halfVox, -halfVox, -halfVox));
    voxelParams.Floats["u_corner2"].SetValue(Vector3f(halfVox, -halfVox, -halfVox));
    voxelParams.Floats["u_corner3"].SetValue(Vector3f(-halfVox, halfVox, -halfVox));
    voxelParams.Floats["u_corner4"].SetValue(Vector3f(halfVox, halfVox, -halfVox));
    voxelParams.Subroutines["u_getQuadDecider"].ValueIndex = 2;
    ...
    voxelParams.Floats["u_corner3"].SetValue(Vector3f(halfVox, halfVox, -halfVox));
    voxelParams.Floats["u_corner4"].SetValue(Vector3f(halfVox, halfVox, halfVox));
    voxelParams.Subroutines["u_getQuadDecider"].ValueIndex = 3;
    ...
    voxelParams.Floats["u_corner3"].SetValue(Vector3f(-halfVox, halfVox, halfVox));
    voxelParams.Floats["u_corner4"].SetValue(Vector3f(halfVox, halfVox, halfVox));
    voxelParams.Subroutines["u_getQuadDecider"].ValueIndex = 4;
    ...
    voxelParams.Floats["u_corner3"].SetValue(Vector3f(halfVox, -halfVox, halfVox));
    voxelParams.Floats["u_corner4"].SetValue(Vector3f(halfVox, halfVox, halfVox));
    voxelParams.Subroutines["u_getQuadDecider"].ValueIndex = 5;
    ...
    worldRenderTarget->DisableDrawingInto(vWindowSize.x, vWindowSize.y, true);
