...
bool MTexture3D::GetColorData(Array3D<Vector4b> & outData)
{
...
bool MTexture3D::GetColorData(Array3D<Vector4f> & outData)
{
    if (!IsValidTexture() || !IsColorTexture() ||
        outData.GetWidth() != width || outData.GetHeight() != height || outData.GetDepth() != depth)
        return false;
...
bool MTexture3D::GetGreyscaleData(Array3D<unsigned char> & outData)
{
    if (!IsValidTexture() || !IsColorTexture() ||
        outData.GetWidth() != width || outData.GetHeight() != height || outData.GetDepth() != depth)
        return false;
...
bool MTexture3D::GetGreyscaleData(Array3D<float> & outData)
{
    if (!IsValidTexture() || !IsColorTexture() ||
        outData.GetWidth() != width || outData.GetHeight() != height || outData.GetDepth() != depth)
        return false;
...
bool MTexture3D::GetDepthData(Array3D<unsigned char> & outData)
{
...
bool MTexture3D::GetDepthData(Array3D<float> & outData)
{
    if (!IsValidTexture() || !IsDepthTexture() ||
        outData.GetWidth() != width || outData.GetHeight() != height || outData.GetDepth() != depth)
        return false;
