...
public:
    ...
    static ShaderGenerator::GeneratedMaterial GenerateStaticQuadDrawMaterial(UniformDictionary & params,
                                                                             ShaderInOutAttributes vertexAttrs = DrawingQuad::GetAttributeData(),
                                                                             unsigned int vertexPosIndex = 0, unsigned int vertexUVIndex = 1);

    //Uniform parameter for the time lerp.
    ...
    static ShaderGenerator::GeneratedMaterial GenerateDynamicQuadDrawMaterial(UniformDictionary & params,
                                                                              DataLine endScale = 1.0f,
                                                                              DataLine endColor = Vector4f(1.0f, 1.0f, 1.0f, 1.0f),
                                                                              DataLine endRotation = 0.0f,
                                                                              ShaderInOutAttributes vertexAttrs = DrawingQuad::GetAttributeData(),
