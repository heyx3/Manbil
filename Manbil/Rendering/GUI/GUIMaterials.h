...
public:
    ...
    static ShaderGenerator::GeneratedMaterial GenerateStaticQuadDrawMaterial(UniformDictionary & params, TextureTypes texType,
    ...
    static ShaderGenerator::GeneratedMaterial GenerateDynamicQuadDrawMaterial(UniformDictionary & params, TextureTypes texType,
